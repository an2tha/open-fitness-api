...
export const nutrientsNormalized = pgTable(
  'nutrients_normalized',
  {
    id: integer().primaryKey().generatedAlwaysAsIdentity({
      name: 'nutrients_normalized_id_seq',
      startWith: 1,
      increment: 1,
      minValue: 1,
      maxValue: 2147483647,
  ...
  (table) => [unique('nutrients_normalized_name_unique').on(table.name)],
);

export const nutrientsNormalizedMapping = pgTable(
  'nutrients_normalized_mapping',
  {
    id: integer().primaryKey().generatedAlwaysAsIdentity({
      name: 'nutrients_normalized_mapping_id_seq',
      startWith: 1,
      increment: 1,
      minValue: 1,
      maxValue: 2147483647,
  ...
  (table) => [
    uniqueIndex('nutrients_normalized_mapping_original_idx').using(
      'btree',
      table.originalNutrientId.asc().nullsLast().op('int4_ops'),
    ),
  ],
);
...
export const exercisesNormalized = pgTable(
  'exercises_normalized',
  {
    id: integer().primaryKey().generatedAlwaysAsIdentity({
      name: 'exercises_normalized_id_seq',
      startWith: 1,
      increment: 1,
      minValue: 1,
      maxValue: 2147483647,
  ...
  (table) => [unique('exercises_normalized_name_unique').on(table.name)],
);

export const exercisesNormalizedMapping = pgTable(
  'exercises_normalized_mapping',
  {
    id: integer().primaryKey().generatedAlwaysAsIdentity({
      name: 'exercises_normalized_mapping_id_seq',
      startWith: 1,
      increment: 1,
      minValue: 1,
      maxValue: 2147483647,
  ...
  (table) => [
    uniqueIndex('exercises_normalized_mapping_original_idx').using(
      'btree',
      table.originalExerciseId.asc().nullsLast().op('int4_ops'),
    ),
  ],
);
...
export const exerciseMovementPatterns = pgTable(
  ...
  (table) => [
    primaryKey({
      columns: [table.movementPatternId, table.exerciseId],
      name: 'exercise_movement_patterns_exerciseId_movementPatternId_pk',
    }),
  ],
);

export const foodNutrientsNormalized = pgTable(
...
export const exerciseRelationsNormalized = pgTable(
  ...
  (table) => [
    primaryKey({
      columns: [table.toExerciseId, table.relationType, table.fromExerciseId],
      name: 'exercise_relations_normalized_fromExerciseId_toExerciseId_relat',
    }),
  ],
);
...
export const exerciseRelations = pgTable(
  ...
  (table) => [
    primaryKey({
      columns: [table.toExerciseId, table.relationType, table.fromExerciseId],
      name: 'exercise_relations_fromExerciseId_toExerciseId_relationType_pk',
    }),
  ],
);
...
export const exerciseEquipment = pgTable(
  ...
  (table) => [
    primaryKey({
      ...
      name: 'exercise_equipment_exerciseId_equipmentId_pk',
    }),
  ],
);
...
export const foodNutrients = pgTable(
  ...
  (table) => [primaryKey({ columns: [table.nutrientId, table.foodId], name: 'food_nutrients_foodId_nutrientId_pk' })],
);
...
export const exerciseMuscles = pgTable(
  ...
  (table) => [
    primaryKey({
      columns: [table.role, table.muscleId, table.exerciseId],
      name: 'exercise_muscles_exerciseId_muscleId_role_pk',
    }),
  ],
);
...
export const supplementIngredients = pgTable(
  ...
  (table) => [
    primaryKey({
      columns: [table.supplementId, table.ingredientId],
      name: 'supplement_ingredients_supplementId_ingredientId_pk',
    }),
  ],
);
